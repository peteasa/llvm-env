...
echo cmake $SRCDIR -G"Eclipse CDT4 - Unix Makefiles" -DCMAKE_ECLIPSE_VERSION=4.3 -DCMAKE_INSTALL_PREFIX=$INSROOTDIR -DCMAKE_BUILD_TYPE=$BUILDTYPE -DCMAKE_USER_MAKE_RULES_OVERRIDE=$SRCDIR/ClangOverrides.txt
